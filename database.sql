...
-- If you already imported this file before the "theme" column
-- (light/dark mode preference) existed, run this once to add it.
-- Requires MySQL 8.0.29+ or MariaDB; on older MySQL, drop
-- "IF NOT EXISTS" (and only run it if the column isn't there yet).
-- ============================================================
-- ALTER TABLE users ADD COLUMN IF NOT EXISTS theme ENUM('light','dark') NOT NULL DEFAULT 'light';
